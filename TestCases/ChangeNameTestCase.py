...
from Pages import PersonalIDPage
...
class SearchProductClass(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.changeName = PersonalIDPage.YourAccountClass(cls.driver)
    ...
    def test_search_Product(self):
        ...
        self.driver.implicitly_wait(10)
        self.changeName.sign_to_user_account_settings()
        self.driver.implicitly_wait(10)
        self.changeName.click_to_change_name()
        self.driver.implicitly_wait(10)
        self.changeName.change_name()
        self.driver.implicitly_wait(10)
        self.changeName.save_changes()
